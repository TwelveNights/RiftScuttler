...
def check_page_and_return_table(request):
    ...
    if abs_url.find("_tournaments/") != -1:
        ...
        table.cols = [("id", "charfield256"), ("year", "int"), ("location", "text"), ("prize", "int")]
        table.args = []
        table.pk = [("id", "charfield256"), ("year", "int")]
        ...
        table.cols = [("name", "charfield16"), ("category", "charfield10")]
        table.args = []
        ...
        table.tname = "items"
        table.cols = [("id", "int"), ("name", "text"), ("basePrice", "int")]
        table.args = []
        table.pk = [("id", "int")]
        ...
        table.args = []
        table.pk = [("id", "charfield6"), ("region", "charfield2")]
        table.non_pk = ["name"]
        table.non_pk_args = []
        ...
        table.tname = "bans"
        table.cols = [("seriesID", "int"), ("matchNumber", "int"), ("name", "charfield16")]
        table.args = []
        table.pk = [("seriesID", "int"), ("matchNumber", "int"), ("name", "charfield16")]
        table.non_pk = []
        table.non_pk_args = []
    elif abs_url.find("_organizes/") != -1:
        table.tname = "organizes"
        table.cols = [("tournamentID", "charfield256"), ("year", "int"), ("seriesID", "int"), ("stage", "text")]
        table.args = []
        ...
        table.cols = [("seriesID", "int"), ("team1ID", "charfield6"), ("team1Region", "charfield2"), ("team2ID", "charfield6"), ("team2Region", "charfield2"), ("winner", "charfield6")]
        table.args = []
        table.pk = [("seriesID", "int"), ("team1ID", "charfield6"), ("team1Region", "charfield2"), ("team2ID", "charfield6"), ("team2Region", "charfield2")]
        table.non_pk = ["winner"]
        table.non_pk_args = []
        ...
        table.cols = [("tournamentID", "charfield256"), ("teamID", "charfield6"), ("teamRegion", "charfield2"), ("year", "int"), ("stageReached", "text")]
        table.args = []
        table.pk = [("tournamentID", "charfield256"), ("teamID", "charfield6"), ("teamRegion", "charfield2"), ("year", "int")]
        table.non_pk = ["stage"]
        table.non_pk_args = ["stageReached"]
    elif abs_url.find("_plays/") != -1:
        table.tname = "plays"
        table.cols = [("seriesID", "int"), ("matchNumber", "int"), ("playerID", "int"), ("champion", "charfield16"), ("role", "charfield6"), ("kills", "int"), ("deaths", "int"), ("assists", "int"), ("damageDealt", "int"), ("wardsPlaced", "int"), ("gold", "int")]
        table.args = []
        table.pk = [("seriesID", "int"), ("matchNumber", "int"), ("playerID", "int"), ("champion", "charfield16")]
        table.non_pk = ["role", "kills", "deaths", "assists", "damageDealt", "wardsPlaced", "gold"]
        table.non_pk_args = []
    elif abs_url.find("_registers/") != -1:
        table.tname = "registers"
        table.cols = [("playerID", "int"), ("teamID", "charfield6"), ("teamRegion", "charfield2"), ("dateJoined", "date"), ("dateLeft", "date")]
        table.args = []
        table.pk = [("playerID", "int"), ("teamID", "charfield6"), ("teamRegion", "charfield2")]
        table.non_pk = ["dateJoined", "dateLeft"]
        table.non_pk_args = []
    elif abs_url.find("_scores/") != -1:
        table.tname = "scores"
        table.cols = [("teamID", "charfield6"), ("teamRegion", "charfield2"), ("seriesID", "int"), ("matchNumber", "int"), ("inhibitors", "int"), ("towers", "int"), ("riftHeralds", "int"), ("barons", "int"), ("dragons", "int"), ("nexus", "int")]
        table.args = []
